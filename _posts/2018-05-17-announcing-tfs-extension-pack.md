...
I'm pleased to announce the initial release of TFS Extension Pack for AnyStatus, now available on the [Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=anystatus.TFSExtensionPack).
